      ...
      <div className={styles.cardsGrid /* same two-col grid */}>
        ...
        <section className={styles.card}>
          ...
          <table className={styles.detailTable}>
            <tbody>
              <tr><th>Project ID</th>      <td>{proj.projectId}</td></tr>
              <tr><th>Project No.</th>     <td>{s['Project No']}</td></tr>
              <tr><th>Project Name</th>    <td>{s['Project Description']}</td></tr>
              <tr><th>Company</th>         <td>{s['Company Name']}</td></tr>
              <tr><th>City</th>            <td>{s['City']}</td></tr>
              <tr><th>Project Mode</th>    <td>{s['Project Mode']}</td></tr>
            </tbody>
          </table>
        </section>
